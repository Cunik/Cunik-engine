...
ip_addr1 = '10.0.120.101'
# ip_addr2 = '10.0.120.101'

if 1 in L:
    CunikApi.create('redis-server-osv', params={'ipv4_addr': ip_addr1})
    #CunikApi.create('redis-server-osv', params={'ipv4_addr': ip_addr2})
    print('created')
    time.sleep(2)
